...
RSpec.describe StreetsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all streets as @streets" do
      ...
      expect(assigns(:streets)).to eq([street])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested street as @street" do
      ...
      expect(assigns(:street)).to eq(street)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new street as @street" do
      ...
      expect(assigns(:street)).to be_a_new(Street)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created street as @street" do
        post :create, {:street => valid_attributes}, valid_session
        expect(assigns(:street)).to be_a(Street)
        expect(assigns(:street)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved street as @street" do
        post :create, {:street => invalid_attributes}, valid_session
        expect(assigns(:street)).to be_a_new(Street)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested street" do
        street = Street.create! valid_attributes
        put :update, {:id => street.to_param, :street => new_attributes}, valid_session
        street.reload
    ...
    context "with invalid params" do
      it "assigns the street as @street" do
        street = Street.create! valid_attributes
        put :update, {:id => street.to_param, :street => invalid_attributes}, valid_session
        expect(assigns(:street)).to eq(street)
      end
