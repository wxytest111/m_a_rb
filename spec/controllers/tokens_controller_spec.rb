  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved token as @token" do
        post :create, {:token => invalid_attributes}, valid_session
        expect(assigns(:token)).to be_a_new(Token)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested token" do
        token = Token.create! valid_attributes
        put :update, {:id => token.to_param, :token => new_attributes}, valid_session
        token.reload
    ...
    context "with invalid params" do
      it "assigns the token as @token" do
        token = Token.create! valid_attributes
        put :update, {:id => token.to_param, :token => invalid_attributes}, valid_session
        expect(assigns(:token)).to eq(token)
      end
